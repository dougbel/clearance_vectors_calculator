...
from vedo import Lines, Spheres, load, colorMap

from it_clearance.testing.tester import TesterClearance
from si.fulldataclearancescores import FullDataClearanceScores
from viewer.point_score.ViewPointScore import ViewPointScore


class ControlPointScore:
    visualized_samples = []
    scores_data = None
    view = None
    ...
    def __init__(self, directory_of_trainings, json_conf_execution_file,
        ...
        self.view = ViewPointScore(self, self.file_mesh_env)
